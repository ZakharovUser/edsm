...
export const _appRelated = ['Chrome', 'Drive', 'Dropbox', 'Evernote', 'Github'].map(
  (name, index) => {
    ...
    const shortcut =
      (name === 'Chrome' && `${CONFIG_GLOBAL.assetsDir}/assets/icons/app/ic_chrome.svg`) ||
      (name === 'Drive' && `${CONFIG_GLOBAL.assetsDir}/assets/icons/app/ic_drive.svg`) ||
      (name === 'Dropbox' && `${CONFIG_GLOBAL.assetsDir}/assets/icons/app/ic_dropbox.svg`) ||
      (name === 'Evernote' && `${CONFIG_GLOBAL.assetsDir}/assets/icons/app/ic_evernote.svg`) ||
      `${CONFIG_GLOBAL.assetsDir}/assets/icons/app/ic_github.svg`;
